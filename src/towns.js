...
const errorLoading = homeworkContainer.querySelector('#error-loading');
...
filterInput.addEventListener('keyup', function () {
    ...
    let matches = citiesList.filter(city => isMatching(city.name, val));
    ...
    matches.forEach(city => {
        filterResult.appendChild(createCitiesNode(city));
    });
});

function createCitiesNode(city) {
